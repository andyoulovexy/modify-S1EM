...
echo INIT | /data/moloch/db/db.pl --insecure https://elastic:kr1TLSfOyWIWkj@es01:9200 init --shards 1 --replicas 1 --refresh 30| tee -a /arkime/log/$(hostname).log > /dev/null;
